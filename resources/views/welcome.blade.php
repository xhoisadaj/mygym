                ...
                <div class="flex flex-col justify-center items-center">
                    ...
                    @if (Route::has('login'))
                        ...
                        @else
                            ...
                            <a href="{{ route('register') }}" class="px-4 py-2 bg-red-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-500 focus:bg-blue-500 active:bg-blue-500 focus:outline-none focus:ring-2 focus:bg-blue-500 focus:ring-offset-2 transition ease-in-out duration-150">Register</a>
                        @endauth
                    @endif
                    </div>
                </div>
